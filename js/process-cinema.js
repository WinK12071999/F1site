/**
 * Process cinema — pinned film-strip timeline, dual-buffer loops, hard cuts.
 */
(function () {
  'use strict';

  var body = document.body;
  if (!body || body.getAttribute('data-page') !== 'process') return;
  ...
  ready(function () {
    var stage = document.querySelector('.prc-hero-stage');
    var heroEl = document.querySelector('.prc-hero-loop');
    var strip = document.querySelector('.prc-strip');
    var track = document.querySelector('.prc-track');
    var acts = [].slice.call(document.querySelectorAll('.prc-act'));
    var tcEl = document.querySelector('[data-prc-tc]');
    var actEl = document.querySelector('[data-prc-act]');
